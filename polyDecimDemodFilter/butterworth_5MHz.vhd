...
-- Name: butterworth_5MHz
-- TestBenchName: butterworth_5MHz_tb
...
END butterworth_5MHz;


----------------------------------------------------------------
--Module Architecture: butterworth_5MHz
----------------------------------------------------------------
ARCHITECTURE rtl OF butterworth_5MHz IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT scaleconst1                    : signed(15 DOWNTO 0) := to_signed(2928, 16); -- sfix16_En17
  ...
  CONSTANT coeff_a2_section1              : signed(15 DOWNTO 0) := to_signed(-28448, 16); -- sfix16_En14
  CONSTANT coeff_a3_section1              : signed(15 DOWNTO 0) := to_signed(13528, 16); -- sfix16_En14
  CONSTANT scaleconst2                    : signed(15 DOWNTO 0) := to_signed(2566, 16); -- sfix16_En17
  ...
  CONSTANT coeff_a2_section2              : signed(15 DOWNTO 0) := to_signed(-24931, 16); -- sfix16_En14
  CONSTANT coeff_a3_section2              : signed(15 DOWNTO 0) := to_signed(9830, 16); -- sfix16_En14
  CONSTANT scaleconst3                    : signed(15 DOWNTO 0) := to_signed(17921, 16); -- sfix16_En17
  ...
  CONSTANT coeff_a2_section3              : signed(15 DOWNTO 0) := to_signed(-11904, 16); -- sfix16_En14
