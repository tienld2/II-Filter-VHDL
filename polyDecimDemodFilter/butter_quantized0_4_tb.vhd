-- -------------------------------------------------------------
--
-- Module: butter_quantized0_4_tb_pkg
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2013-09-10 15:32:19
-- -------------------------------------------------------------
...
PACKAGE butter_quantized0_4_tb_pkg IS
...
END butter_quantized0_4_tb_pkg;

PACKAGE BODY butter_quantized0_4_tb_pkg IS
...
-- -------------------------------------------------------------
--
-- Module: butter_quantized0_4_tb_data
-- Generated by MATLAB(R) 8.1 and the Filter Design HDL Coder 2.9.3.
-- Generated on: 2013-09-10 15:32:19
-- -------------------------------------------------------------
...
USE IEEE.std_logic_1164.all;
USE IEEE.numeric_std.ALL;
USE work.butter_quantized0_4_tb_pkg.ALL;

PACKAGE butter_quantized0_4_tb_data IS

  CONSTANT filter_in_data_log_force : filter_in_data_log_type;
  CONSTANT filter_out_expected : filter_in_data_log_type;

END butter_quantized0_4_tb_data;

PACKAGE BODY butter_quantized0_4_tb_data IS
...
USE work.butter_quantized0_4_tb_data.ALL;

ENTITY butter_quantized0_4_tb IS

END butter_quantized0_4_tb;


ARCHITECTURE rtl OF butter_quantized0_4_tb IS
  -- -------------------------------------------------------------
  -- Component Declarations
  -- -------------------------------------------------------------
  COMPONENT butter_quantized0_4
  ...
  -- -------------------------------------------------------------
  FOR ALL : butter_quantized0_4
    USE ENTITY work.butter_quantized0_4(rtl);
...
BEGIN
  -- Component Instances
  u_butter_quantized0_4: butter_quantized0_4
    PORT MAP (
              clk                              => clk,
